...
compared the winrate, average time steps in a game, average food eaten in a
game, average number of collisions in a game, and average number of heads hunted
in a game in figure \ref{fig:winrate}, \ref{fig:time_steps},
