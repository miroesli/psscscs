...
agains the old one and further replace it if performance is better.
...
snake will quickly struggle identify where it's head lies. To make the task
...
percieve the original board in the worst case. Additionally, every snake has
